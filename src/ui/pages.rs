...
<ul class="feat-list">
  <li><strong>Dynamic Memory Governor:</strong> Operates under a 200MB hard RSS ceiling. At 140MB, proactive eviction runs; at 175MB, emergency cache shedding instantly resets memory to ~45MB.</li>
